		...
		public:
			...
			void Update() {
				if (m_gameObject) {
					...
					if ((m_gameObject->Position.y - Radius) < -2.0f || m_gameObject->Position.y + Radius > 2.0f) {
						if (m_gameObject->Position.y - Radius < -2.0f)
							m_gameObject->Translate(XMFLOAT3(0.0f, -2.0f - m_gameObject->Position.y + Radius, 0.0f));
						else
							m_gameObject->Translate(XMFLOAT3(0.0f, 2.0f - m_gameObject->Position.y - Radius, 0.0f));
					...
					if (m_gameObject->Position.x - Radius < -3.5f || m_gameObject->Position.x + Radius> 3.5f) {
						if (m_gameObject->Position.x - Radius < -3.5f)
							m_gameObject->Translate(XMFLOAT3(-3.5f - m_gameObject->Position.x + Radius, 0.0f, 0.0f));
						else 
							m_gameObject->Translate(XMFLOAT3( 3.5f - m_gameObject->Position.x - Radius, 0.0f, 0.0f));
